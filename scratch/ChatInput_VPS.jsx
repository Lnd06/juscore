...
const ChatInput = ({ 
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full z-20 px-3 sm:px-4 pb-5 sm:pb-3 pt-10 flex justify-center pointer-events-none">
      <div className="relative w-full max-w-6xl pointer-events-auto">
        ...
        <div className="relative group bg-white dark:bg-gray-900/90 backdrop-blur-xl border border-gray-200 dark:border-gray-700/50 rounded-2xl sm:rounded-[2rem] p-1.5 sm:p-2 shadow-2xl dark:shadow-black/50 transition-all focus-within:ring-1 focus-within:ring-accent/50 focus-within:border-accent/50 flex items-end gap-1.5 sm:gap-2 text-gray-900 dark:text-gray-200">
           ...
           <textarea
             ...
             className="flex-1 bg-transparent border-none py-2 sm:py-2.5 px-1 sm:px-2 text-sm sm:text-base text-gray-900 dark:text-gray-200 placeholder:text-gray-400 dark:placeholder:text-gray-600 focus:ring-0 outline-none resize-none max-h-[200px] min-w-0"
             rows={1}
           />
         ...
         <div className="mt-2.5 hidden sm:flex flex-wrap justify-center items-center gap-x-4 gap-y-1.5 text-[10px] font-semibold text-gray-400 dark:text-gray-500 pointer-events-none">
           <span className="flex items-center gap-1.5">
             <Lock className="w-3.5 h-3.5 text-emerald-500/80" />
             Privacidade Total (LGPD): Anonimização Ativa localmente
           </span>
           <span className="hidden sm:inline w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-700"></span>
           <span className="flex items-center gap-1.5">
             <Sparkles className="w-3.5 h-3.5 text-indigo-500/80" />
             I.A. Contextual: Memória de Conversa e Contexto Herdado
           </span>
         </div>
       </div>
